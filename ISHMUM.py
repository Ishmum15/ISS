...
---------------------------------------------------
 ...
 [•] Version   :  \033[1;32m 2.5\033[1;32m \033[1;37m
---------------------------------------------------''')
	p(logo)
def clear():
	os.system("clear")
...
class iAmMain:
	...
	def method1(self,uid,nm,pwx):
		try:
			...
			ishmum_ua = f"[FBAN/{fban};FBAV/{facebook_version};FBLC/en_US;FBBV/{fbbv};FBCR/{fbcr};FBMF/Samsung;FBBD/Vivo;FBDV/Vivo;FBSV/13;FBCA/armeabi-v7a:armeabi;FBDM/"+"{"+f"density={density},width={width},height={height}]"
			fn = nm.split(' ')[0]
			try:
				ln = nm.split(' ')[1]
			except:
...
'X-FB-Server-Cluster': 'True',}
	...
	def method2(self,uid,nm,pwx):
		try:
			...
			ishmum_ua = f"[FBAN/{fban};FBAV/{facebook_version};FBLC/en_US;FBBV/{fbbv};FBCR/{fbcr};FBMF/Samsung;FBBD/Samsung;FBDV/SM-M236L;FBSV/13;FBCA/armeabi-v7a:armeabi;FBDM/"+"{"+f"density={density},width={width},height={height}]"
			fn = nm.split(' ')[0]
			try:
				ln = nm.split(' ')[1]
			except:
